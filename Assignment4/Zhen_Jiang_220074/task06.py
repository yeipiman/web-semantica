...
Original file is located at
    https://colab.research.google.com/drive/1iwCU06W4WbkK7SH119T8YWEF4xxmvKnH
...
# Oscar
g.add((person.Oscar, vcard.FN,     Literal("Oscar Corcho", datatype=XSD.string)))
...
g.add((person.Oscar, foaf.email,   Literal("ocorcho@upm.es", datatype=XSD.string)))
