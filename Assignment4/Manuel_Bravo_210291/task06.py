...
Original file is located at
    https://colab.research.google.com/drive/16YrnGeksFid1j9BMOT1K2YL975EzhZ9i
...
#Labels         *Acuerdate de poner tipo string
...
g.add((person.Oscar, vcard.FN, Literal("Oscar Corcho García", datatype=XSD.string)))
