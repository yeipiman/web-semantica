...
Original file is located at
    https://colab.research.google.com/drive/12WgBNa6vhj6unPToGRLcE66gslmmlzw_
...
# Creo los namespaces para vocabulario (ontology) y para recursos/personas (person)
ontology = Namespace("http://oeg.fi.upm.es/def/people#")
person   = Namespace("http://oeg.fi.upm.es/resource/person/")

# Los asocio al grafo con prefijos legibles
...
# TO DO
# Creo las clases, sus etiquetas y las relaciones de subclase siguiendo el diagrama.
...
# TO DO
# Añado todas las propiedades con sus labels y sus dominios/rangos RDFS.
# Diseño:
# - hasName: domain Person, range Literal (xsd:String)
# - hasColleague: domain Person, range Person
# - hasHomePage: domain FullProfessor, range Literal (se puede usar xsd:anyURI como literal)
...
# TO DO
# Creo los individuos Oscar, Asun y Raul y los enlazo según el diagrama de la clase creada en task02.
# Elección de tipos: Oscar -> AssociateProfessor, Asun -> FullProfessor, Raul -> InterimAssociateProfessor
# Relaciones hasName, hasColleague y hasHomePage
...
# etiquetas (labels) literales en xsd:String
...
# propiedades de datos y relaciones
...
# TO DO
# Defino los namespaces VCARD y FOAF y añado las propiedades solicitadas a Oscar.
