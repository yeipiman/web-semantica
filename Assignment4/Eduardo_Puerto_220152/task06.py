...
Original file is located at
    https://colab.research.google.com/drive/1CAtH8RuMvny8DThH9CjQqVA-7q6bQGzw
...
g.add((ontology.hasName, RDFS.range, RDFS.Literal)) # Literal para un nombre

# Propiedad ontology:hasColleague
...
g.add((ontology.hasColleague, RDFS.range, ontology.Person)) # Persona (Profesor) es colega de otra Persona (Profesor)

# Propiedad ontology:hasHomePage
...
g.add((ontology.hasHomePage, RDFS.range, RDFS.Literal)) # URL como literal
# Podría usarse también XSD.anyURI, pero se pide literal si no tiene rango y el ejemplo de dato es un string literal
# Aunque la diapositiva 36 muestra la flecha apuntando a rdfs:Literal (con dominio FullProfessor)
# el dato específico en la diapositiva 36 es un IRI: http://oeg.fi.upm.es/
...
g.add((person.Oscar, ontology.hasName, Literal("Oscar Corcho García")))
