...
Original file is located at
    https://colab.research.google.com/drive/1e3gsPINZwdCtNF479GTe4fpHHpX71sW_
...
for s, p, o in g.triples((None, RDFS.label, None)):
    print(s, o, type(o), getattr(o, 'datatype', None))
...
# Propiedades takesCourse, teachesCourse, isStudentOf
...
# TASK 6.4 — Add contact information to person:Oscar

# Namespaces
foaf = Namespace("http://xmlns.com/foaf/0.1/")
vcard = Namespace("http://www.w3.org/2001/vcard-rdf/3.0/")

# Add Oscar’s contact and identity details
contact_info = {
    vcard.Given: "Oscar",
    vcard.Family: "Corcho Garcia",
    foaf.email: "ocorcho@fi.upm.es"
}

for prop, value in contact_info.items():
    g.add((person.Oscar, prop, Literal(value, datatype=XSD.string)))

# Optional: preview all triples
print("\nTriples currently in the graph:\n" + "-"*40)
for s, p, o in g:
    print(s, p, o)
