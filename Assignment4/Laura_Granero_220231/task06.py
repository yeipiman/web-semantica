...
Original file is located at
    https://colab.research.google.com/drive/1wlY_UDruLWF8ulVBgVAfC4CkWXkCGE6N
...
# creamos prefijos para la ontología y persona
...
# Creamos clases, subclases y labels
# Labels : person, professor, associateProfessor, InterimAssociateProfessor
...
# Classes : person, professor, associateProfessor, InterimAssociateProfessor
...
# Subclasses : person, professor, associateProfessor, InterimAssociateProfessor
g.add((ontology.Person, RDFS.subClassOf, RDFS.Class))
...
# Creamos a las personas con sus relaciones y literales
# Individuals
...
# Añadimos a Oscar el email,nombre y apellido
# VCARD Y FOAF
...
g.add((person.Oscar, Foaf.email, Literal("oscarcorcho@fi.upm.es", datatype=XSD.string)))
