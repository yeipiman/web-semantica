...
Original file is located at
    https://colab.research.google.com/drive/1IxS87ZRdOfwWln92kPiHVshfr7Ya4HiD
...
# Los añadimos al gestor de namespaces
...
# Definimos las relaciones jerárquicas
...
# Añadimos etiquetas (datatype xsd:string)
...
# TO DO
# Añadimos los namespaces usados en el ejemplo
vcard = Namespace("http://www.w3.org/2001/vcard-rdf/3.0/")
foaf = Namespace("http://xmlns.com/foaf/0.1/")

# Añadimos las nuevas propiedades a Oscar
