...
g.add((person.Oscar, ontology.hasHomePage, Literal("http://oeg.fi.upm.es/", datatype=XSD.string)))

g.add((person.Asun, RDF.type, ontology.AssociateProfessor))
g.add((person.Asun, RDFS.label, Literal("Asun", datatype=XSD.string)))
g.add((person.Asun, ontology.hasName, Literal("Asun", datatype=XSD.string)))
...
g.add((person.Raul, ontology.hasName, Literal("Raul", datatype=XSD.string)))
...
g.add((person.Oscar, foaf.email, Literal("oscar@oeg.fi.upm.es", datatype=XSD.string)))
