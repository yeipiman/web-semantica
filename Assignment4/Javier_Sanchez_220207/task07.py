...
Original file is located at
    https://colab.research.google.com/drive/13xmVisDcQiueoN6gW-srwM4CMxptP6rt
...
for class_uri in g.subjects(RDF.type, RDFS.Class):
    # Buscamos su superclase
    superclasses = list(g.objects(class_uri, RDFS.subClassOf))
    if superclasses:
...
# variable to return
individuals = []
classes_to_check = set([ns.Person])
checked_classes = set()
...
for c in checked_classes:
    for individual in g.subjects(RDF.type, c):
...
WHERE {
    ?ind ontology:hasColleague* ?coll .
    ?coll ontology:ownsPet ?pet .
