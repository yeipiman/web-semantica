...
Original file is located at
    https://colab.research.google.com/drive/116p-uyHFIbekSSPSbtbMH0AwBz8U4NRM
...
vcardrdf = Namespace("http://www.w3.org/2001/vcard-rdf/3.0/")
g.add((person.Oscar, vcardrdf.Given, Literal("Oscar", datatype=XSD.string)))
g.add((person.Oscar, vcardrdf.Family, Literal("Corcho", datatype=XSD.string)))
g.add((person.Oscar, foaf.email, Literal("ocorcho@somewhere.com", datatype=XSD.string)))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
