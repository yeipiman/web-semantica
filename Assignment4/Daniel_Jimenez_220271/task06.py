...
Original file is located at
    https://colab.research.google.com/drive/1dxFb5aP-AUorExDdqaOXRfPGlqqbCrqi
...
classes = [
    "Person", "Professor", "FullProfessor", "AssociateProfessor",
...
properties = {
    "hasName": {
        "domain": ontology.Person,
        "range": RDFS.Literal
    },
    "hasColleague": {
        "domain": ontology.Person,
        "range": ontology.Person
    },
    "hasHomePage": {
        "domain": ontology.FullProfessor,
        "range": RDFS.Literal
    }
}

for prop, info in properties.items():
    g.add((ontology[prop], RDF.type, RDF.Property))
    g.add((ontology[prop], RDFS.label, Literal(prop, datatype=XSD.string)))
    g.add((ontology[prop], RDFS.domain, info["domain"]))
    if info["range"]:
        g.add((ontology[prop], RDFS.range, info["range"]))
...
g.add((person.Oscar, FOAF.email, Literal("oscar.corcho@example.org", datatype=XSD.string)))
